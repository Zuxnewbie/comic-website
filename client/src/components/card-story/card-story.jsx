    ...
    <>
      ...
      <div className="description">
        ...
        <div className="description-content">
          <p>
            Khi Quỷ vương bị anh hùng thách thức, nói rằng hắn không biết gì về
            tình yêu, hắn ta thâm nhập vào học viện anh hùng của loài ngươi, nơi
            sự lãng mạn thăng hoa nhất. Và rồi cuối cùng phát hiện ra mục tiêu
            của thánh viện này... chính là giết chết Quỷ vương.
          </p>
        </div>
      </div>
    </>
